...
const Modal = ({ show, closeModal, inner, headerImage, projectName, technologies }) => {
  ...
  const headerImageElement = headerImage == null ? '' : <GatsbyImage className={styles.Image} image={headerImage} />
  return (
    <>
