...
const NavigationItem = ({ location, target, children, sidebarCloseHandler, shouldChangeOnActive }) => {
  ...
  const activeButtonStyleClassesString = shouldChangeOnActive ? activeButtonStyleClasses.join(' ') : ''
